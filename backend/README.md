...
## Project Structure
    ...
    ├── maneuver_warfare_35030  # Django project configurations
...
1. Clone this repo and `cd maneuver_warfare_35030`
...
2. Clone this repo and `cd maneuver_warfare_35030`
